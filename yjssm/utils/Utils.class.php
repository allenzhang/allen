...
class Utils{
	...
	public static function getNewsInfo($wid, $zoneId){
	...
	public static function getNewsById($wid, $newsId){
	...
	public static function callApiByCurl($URL, $opts = array()) {
		...
		$h[0] = "Accept-Language: zh-cn,zh;q=0.5";
