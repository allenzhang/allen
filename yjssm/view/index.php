<?php require_once dirname(__FILE__) . '/inc/header.html'; ?>
			...
			<div class="span10 offset1" style="margin-top:20px">
				<div style="background-color:#eee;width:33.3%;height: 300px;float:left;">
					<div style="margin:25px;line-height:30px;">	
						...
						<p style="text-align:right;"><a href="<?php echo $this->domain.'/contact.html'; ?>">更多信息&gt;&gt;</a></p>
					</div>
				</div>
		...
		<div class="row-fluid">
			<div class="span10 offset1" style="overflow:hidden">
		...
		<div class="row-fluid">
			<div class="span10 offset1" style="overflow:hidden">
				...
				<div class="span4 shadow-box" style="">
			...
			<div class="span10 offset1" style="margin-top:10px">
				<div class="span4">
					...
					foreach($this->arrNews[7] as $news){
						...
						if($index<7){
					?>
						<li><a style="color:#5B5B5B;" href="<?php echo $this->domain.'/news_'.$news['id'].'.html';?>"><?php echo String::trword($news['content'],15); ?></a></li>
					<?php }}?>
					</ul>
					<p style="text-align:center"><a href="<?php echo $this->domain.'/news.html'; ?>">更多信息&gt;&gt;</a></p>
				...
				<div class="span4">
					...
					<p style="text-align:center"><a href="<?php echo $this->domain.'/network.html';?>">更多信息&gt;&gt;</a></p>
				</div>
				<div class="span4">
					<h5>在线留言</h5>
