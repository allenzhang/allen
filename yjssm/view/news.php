...
<div class="row-fluid" style="margin-top:10px;">
	...
	<div class="span7">
		<div style="background-color:#eee;margin-bottom:10px;overflow:hidden">
			<div style="float:right;width:50%">
				<div style="margin:15px">
					<h4><a href="./news_<?php echo $this->arrNews[7][0]['id'];?>.html"><?php echo $this->arrNews[7][0]['title']; ?></a></h4>
		...
		<div style="width:50%;float:left;margin-top:10px">
			<div style="width:100%"><a href="./news_<?php echo $news['id'];?>.html"><h5><?php echo $news['title'];?></h5></a></div>
			<div style="width:100%;overflow:hidden">
				<div style="width:30%;float:left"><a href="./news_<?php echo $news['id'];?>.html"><img style="width:90px;height:90px" src="<?php echo $news['imgInfo'][0]['path'] ?>"/></a></div>
